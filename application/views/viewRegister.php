...
<html class="bg-black">
    ...
    <body class="bg-black">
            ...
            <form id="registerform" action="" method="post">
                <div class="body bg-gray">
                    <div class="form-group">
                        <input type="text" name="nl" class="form-control" placeholder="Nama Lengkap"/>
                    </div>
                    <div class="form-group">
                ...
                <div class="footer">                                                               
                    ...
                    <a href="<?php echo base_url(); ?>login" class="text-center">Kembali Ke Halaman Login</a>
                </div>
            </form>
        ...
        <script src="<?php echo base_url(); ?>assets/js/page/register.js" type="text/javascript"></script>        
